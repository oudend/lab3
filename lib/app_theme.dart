...
class AppTheme {
  ...
  static final shimmer = _ShimmerTheme();

  static TextTheme textTheme = GoogleFonts.nunitoTextTheme();
  static TextTheme logoTextTheme = GoogleFonts.indieFlowerTextTheme();

  // App color
  static ColorScheme colorScheme = ColorScheme.fromSeed(
    seedColor: Colors.yellow.shade100, // Välj något som känns bra
  );
}
